...
<div class="row">
	<div class="col-md-12">
		...
		<?php if($company_logo != ''){ ?>
			<div class="row">
				<div class="col-md-9">
					<img src="<?php echo base_url('uploads/' . APP_ENC_KEY . '/company/'.$company_logo); ?>" class="img img-responsive">
				</div>
		...
		<?php if($company_logo_dark != ''){ ?>
			<div class="row">
				<div class="col-md-9">
					<img src="<?php echo base_url('uploads/' . APP_ENC_KEY . '/company/'.$company_logo_dark); ?>" class="img img-responsive">
				</div>
				<?php if(has_permission('settings','','delete')){ ?>
					<div class="col-md-3 text-right">
