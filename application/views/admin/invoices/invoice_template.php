                ...
                <div class="form-group">
                  ...
                  ?>
                        ...
                        <input type="text" name="number" class="form-control"
                               ...
                               data-original-number="<?php echo $data_original_number; ?>" <?php echo ($_is_draft) ? 'disabled' : '' ?>>
                        <?php if ($format == 3) { ?>
                            <span class="input-group-addon">
            ...
            <div class="col-md-<?php if (!isset($invoice_from_project)) {
                ...
                <div class="mtop10">
                    ...
                    <div class="radio radio-primary radio-inline">
                        ...
                        <label for="sq_3"><?php echo _l('invoice_table_quantity_heading'); ?>
                            /<?php echo _l('invoice_table_hours_heading'); ?></label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
                ...
                <tr>
                    ...
                    <th width="20%" align="left"><i class="fa fa-exclamation-circle" aria-hidden="true"
                                                    data-toggle="tooltip"
                                                    data-title="<?php echo _l('item_description_new_lines_notice'); ?>"></i> <?php echo _l('invoice_table_item_heading'); ?>
                    </th>
                                      ...
                                      <span class="discount-total-type-selected">
                                        ...
                                        ?>
                                            ...
                                            <ul class="dropdown-menu" id="discount-total-type-dropdown"
                                                ...
                                                <li>
                                                    <a href="#"
                                                       class="discount-total-type discount-type-percent<?php if (!isset($invoice) || (isset($invoice) && is_sale_discount($invoice, 'percent')) || (isset($invoice) && !is_sale_discount_applied($invoice))) {
                                                           echo ' selected';
                                                       } ?>">%</a>
                                                </li>
                                                <li><a href="#"
                                                       class="discount-total-type discount-type-fixed<?php if (isset($invoice) && is_sale_discount($invoice, 'fixed')) {
                                                           echo ' selected';
                                                       } ?>">
            ...
            <div class="panel-body bottom-transaction">
                ...
                <div class="btn-bottom-toolbar text-right">
                    ...
                    <div class="btn-group dropup">
                        <button type="button"
                                class="btn-tr btn btn-info invoice-form-submit transaction-submit"><?php echo _l('submit'); ?></button>
