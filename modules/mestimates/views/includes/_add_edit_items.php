    ...
    <table id="mestimate_details" width="100%" class="table table-striped">
            ...
            for ($i = 0; $i < count($details); $i++) {
                ...
                <tr class="tr_parent">
                    ...
                    <td><input value="<?= $detail['px_unit'] ?>" name="detail[px_unit][]" type="text"
                               ...
                               onkeyup="computeLineAmount()" onchange="computeLineAmount()"><br><span
                                class="quantity_uom_1"></span></td>
                    <td><input value="<?= $detail['duration'] ?>" name="detail[duration][]" type="text"
        ...
        <tr>
            ...
            <td><input type="text" name="sub_total"
                       value="<?= (isset($mestimate) && isset($mestimate->sub_total)) ? $mestimate->sub_total : 0.00 ?>"
                       id="sub_total"
                       placeholder="0.00"
                       class="col-xs-12 col-sm-12 center"
                       readonly="readonly"></td>
        ...
        <tr>
            ...
            <td><input type="text" id="discount_val" name="discount_val" placeholder="0.00"
                       value="<?= (isset($mestimate) && isset($mestimate->discount_val)) ? $mestimate->discount_val : 0.00 ?>"
                       class="col-xs-12 col-sm-12 center"
                       readonly="readonly"></td>
            <td></td>
        </tr>
        <tr>
            ...
            <td><input type="text" id="total" name="total" placeholder="0.00"
                       value="<?= (isset($mestimate) && isset($mestimate->total)) ? $mestimate->total : 0.00 ?>"
                       class="col-xs-12 col-sm-12 center"
                       readonly="readonly"></td>
            <td></td>
        </tr>
        ...
        <tr>
            ...
            <td><input onkeyup="computeLineAmount()" id="paid_by_customer_percent" onchange="computeLineAmount()"
                       ...
                       value="<?= (isset($mestimate) && isset($mestimate->paid_by_customer_percent)) ? $mestimate->paid_by_customer_percent : 0.00 ?>"
                       class="col-xs-12 col-sm-12 center"></td>
            <td><input type="text" name="balance_due" placeholder="0.00"
                       value="<?= (isset($mestimate) && isset($mestimate->balance_due)) ? $mestimate->balance_due : "" ?>"
