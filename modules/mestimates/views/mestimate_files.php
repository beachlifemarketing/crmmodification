...
if (isset($client_id)) {
    ...
    ?>
    <?php echo form_open_multipart(admin_url('mestimates/upload_file/' . $mestimate_id), array('class' => 'dropzone', 'id' => 'mestimate-files-upload')); ?>
    <input type="file" name="file" multiple/>
    <input type="hidden" name="client_id" id="hid_client_id" value="<?php echo $client_id ?>"/>
    <?php echo form_close(); ?>
    <small class="mtop5"><?php echo _l('mestimate_file_visible_to_customer'); ?></small><br/>
    ...
    <div class="text-right" style="margin-top:-25px;">
        <button class="gpicker" data-on-pick="mestimateFileGoogleDriveSave">
    ...
    <div class="modal fade bulk_actions" id="mestimate_files_bulk_actions" tabindex="-1" role="dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="bulk_change">
                        <div class="form-group">
                            <label class="mtop5"><?php echo _l('mestimate_file_visible_to_customer'); ?></label>
                            <div class="onoffswitch">
                ...
                <div class="modal-footer">
                    ...
                    <a href="#" class="btn btn-info"
                       onclick="mestimate_files_bulk_action(this); return false;"><?php echo _l('confirm'); ?></a>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
    <a href="#" data-toggle="modal" data-target="#mestimate_files_bulk_actions" class="bulk-actions-btn table-btn hide"
       data-table=".table-mestimate-files">
    ...
    <table class="table dt-table scroll-responsive table-mestimate-files" data-order-col="7" data-order-type="desc">
        ...
        <tr>
            ...
            <th><?php echo _l('mestimate_file_visible_to_customer'); ?></th>
        ...
        <?php foreach ($files as $file) {
            ...
            <tr>
                ...
                <td data-order="<?php echo $file['visible_to_customer']; ?>">
                    ...
                    <div class="onoffswitch">
                        <input type="checkbox"
                               data-switch-url="<?php echo admin_url(); ?>mestimates/change_file_visibility"
                ...
                <td>
                    <?php if (empty($file['external'])) { ?>
                        <button type="button" data-toggle="modal"
                                ...
                                data-path="<?php echo FCPATH . 'uploads/mestimates' . '/' . $mestimate_id . '/' . $file['file_name']; ?>"
                                data-target="#send_file" class="btn btn-info btn-icon"><i class="fa fa-envelope"></i>
                        </button>
                    <?php } ?>
                    <?php if ($file['staffid'] == get_staff_user_id() || has_permission('mestimates', '', 'delete')) { ?>
                        <a href="<?php echo admin_url('mestimates/remove_file/' . $mestimate_id . '/' . $file['id'] . '/' . $client_id); ?>"
