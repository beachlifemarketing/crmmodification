...
class Surveys extends AdminController
{
    ...
    public function index()
    {
        ...
        if ($this->input->is_ajax_request()) {
            $this->app->get_table_data(module_views_path('surveys', 'tables/surveys'));
        }
        $data['title'] = _l('surveys');
        $this->load->view('surveys/all', $data);
    }
    ...
    public function survey($id = '')
    {
        ...
        $this->app_css->add('surveys-css', module_dir_url('surveys', 'assets/css/surveys.css'), 'admin', ['app-css']);

        $this->load->view('surveys/survey', $data);
    }
    ...
    public function mail_lists()
    {
        ...
        if ($this->input->is_ajax_request()) {
            $this->app->get_table_data(module_views_path('surveys', 'tables/mail_lists'));
        }
        $data['title'] = _l('mail_lists');
        $this->load->view('surveys/mail_lists/manage', $data);
    }
